...
In this two-part project (HW-11 and HW-12), you are required to answer the following **causal** question:
...
data %>%
  mutate(
    speed_limit = case_when(
      # 1. Highest Priority: slnone (None speed limit ranks highest)
      slnone > 0 ~ NA_real_, 
