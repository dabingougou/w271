...
**Boom**
A significant $\mathbf{5.82\%}$ increase in the state's VMT per capita (equivalent to $531$ additional miles per person annually) is predicted to cause an increase of $0.1339$ traffic fatalities per 100,000 population. This demonstrates that even moderate rises in driving volume—due to post-lockdown mobility or general economic activity—have a detectable, positive, and causal effect on the overall death toll, as captured by the within-state variation.

**Bust**
A severe $\mathbf{39.08\%}$ drop in VMT per capita (a reduction of $3,567$ miles per person) is predicted to cause a substantial decrease of $0.8992$ traffic fatalities per 100,000 population. This finding confirms the fundamental safety relationship: reducing exposure (miles driven) is the single most powerful factor for immediately reducing the absolute number of fatalities. The nearly one-fatality reduction per 100,000 population is a large effect driven entirely by the scale of the reduction in travel.
